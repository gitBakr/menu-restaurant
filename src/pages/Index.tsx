                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <button
                        onClick={() => console.log(`Commander ${dish.translationKey}`)}
                        className="w-full mt-4 bg-restaurant-gold hover:bg-restaurant-gold/80 
                                 text-restaurant-dark font-semibold py-2 px-4 rounded-lg
